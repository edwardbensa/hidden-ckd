...
X = pd.read_csv(config.MODEL_DATA_DIR / 'features.csv')
y = pd.read_csv(config.PROCESSED_DATA_DIR / "hidden_ckd_processed.csv")['CKD_Risk']
...
test_df.to_csv(config.MODEL_DATA_DIR / 'test.csv', index=False)
